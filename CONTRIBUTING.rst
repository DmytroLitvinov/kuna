...
Kuna API wrapper could always use more documentation, whether as part of the
official Kuna API wrapper docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 2.7, 3.5 and 3.6, and for PyPy. Check
   https://travis-ci.org/DmytroLitvinov/kuna/pull_requests
